...
public static partial class S
{
    ...
    { 
        ...
        { AuthAccountNotVerified, new("Cuenta no verificada, revise sus correos electrónicos para ver el enlace de verificación") },
        ...
        { AuthConfirmEmailHtml, new("<div><a href=\"{{BaseHref}}/cmn/auth/verify_email?email={{Email}}&code={{Code}}\">Haga clic en este enlace para verificar su dirección de correo electrónico</a></div>") },
        { AuthConfirmEmailSubject, new("Confirmar el correo") },
        { AuthConfirmEmailText, new("Utilice este enlace para verificar su dirección de correo electrónico: {{BaseHref}}/cmn/auth/verify_email?email={{Email}}&code={{Code}}") },
        ...
        { AuthResetPwdHtml, new("<div><a href=\"{{BaseHref}}/cmn/auth/reset_pwd?email={{Email}}&code={{Code}}\">Haga clic en este enlace para restablecer su contraseña</a></div>") },
        { AuthResetPwdSubject, new("Restablecer la contraseña") },
        { AuthResetPwdText, new("Haga clic en este enlace para restablecer su contraseña: {{BaseHref}}/cmn/auth/reset_pwd?email={{Email}}&code={{Code}}") },
        { AuthThousandsAndDecimalSeparatorsMatch, new("Los caracteres del separador de miles y decimales coinciden") },
        ...
        { DeleteAccountWarning, new("Esto eliminará su cuenta y todos los datos asociados a ella. ¿Aún quieres eliminar tu cuenta?") },
        { Deleting, new("Eliminando") },
        { Demo, new("Manifestación") },
        { DemoTitle, new("Esta aplicación es solo para fines de demostración.\nTodos los datos pueden borrarse en cualquier momento sin previo aviso.") },
        ...
        { RequestBodyTooLarge, new("El cuerpo de la solicitud es demasiado grande; limite {{MaxSize}} bytes") },
        ...
        { StringInvalid, new("Cadena no válida {{Nombre}}, Min {{Min}}, Max {{Max}}, Regexes {{Regexes}}") },
        { Success, new("Éxito") },
