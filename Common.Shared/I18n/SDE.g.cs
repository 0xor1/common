...
public static partial class S
{
    ...
    { 
        ...
        { AuthAccountNotVerified, new("Konto nicht bestätigt, bitte überprüfen Sie Ihre E-Mails auf den Bestätigungslink") },
        ...
        { AuthConfirmEmailHtml, new("<div><a href=\"{{BaseHref}}/cmn/auth/verify_email?email={{Email}}&code={{Code}}\">Bitte klicken Sie auf diesen Link, um Ihre E-Mail-Adresse zu bestätigen</a></div>") },
        { AuthConfirmEmailSubject, new("e-Mail-Adresse bestätigen") },
        { AuthConfirmEmailText, new("Bitte verwenden Sie diesen Link, um Ihre E-Mail-Adresse zu bestätigen: {{BaseHref}}/cmn/auth/verify_email?email={{Email}}&code={{Code}}") },
        ...
        { AuthMagicLinkHtml, new("<div><a href=\"{{BaseHref}}/cmn/auth/magic_link_sign_in?email={{Email}}&code={{Code}}&remember_me={{RememberMe}}\">Bitte klicken Sie auf diesen Link, um sich anzumelden</a ></div>") },
        { AuthMagicLinkSubject, new("Magic-Login-Link") },
        { AuthMagicLinkText, new("Bitte klicken Sie auf diesen Link, um sich anzumelden: {{BaseHref}}/cmn/auth/magic_link_sign_in?email={{Email}}&code={{Code}}&remember_me={{RememberMe}}") },
        ...
        { AuthResetPwdHtml, new("<div><a href=\"{{BaseHref}}/cmn/auth/reset_pwd?email={{Email}}&code={{Code}}\">klicken Sie bitte auf diesen Link, um Ihr Passwort zurückzusetzen</a></div>") },
        { AuthResetPwdSubject, new("Passwort zurücksetzen") },
        { AuthResetPwdText, new("Bitte klicken Sie auf diesen Link, um Ihr Passwort zurückzusetzen: {{BaseHref}}/cmn/auth/reset_pwd?email={{Email}}&code={{Code}}") },
        { AuthThousandsAndDecimalSeparatorsMatch, new("Tausender- und Dezimaltrennzeichen stimmen überein") },
        ...
        { DeleteAccountWarning, new("Dadurch werden Ihr Konto und alle damit verbundenen Daten gelöscht. Möchten Sie Ihr Konto trotzdem löschen?") },
        ...
        { SendMagicLinkSuccess, new("Wenn diese E-Mail mit einem Konto übereinstimmt, wird eine E-Mail mit Ihrem Magic-Login-Link gesendet.") },
        ...
        { StringInvalid, new("Ungültiger String {{Name}}, Min. {{Min}}, Max. {{Max}}, Regexes {{Regexes}}") },
        { Success, new("Erfolg") },
