...
public static partial class S
{
    ...
    { 
        ...
        { AuthAccountNotVerified, new("Account not verified, please check your emails for verification link") },
        ...
        { AuthConfirmEmailHtml, new("<div><a href=\"{{BaseHref}}/cmn/auth/verify_email?email={{Email}}&code={{Code}}\">Please click this link to verify your email address</a></div >") },
        { AuthConfirmEmailSubject, new("Confirm Email Address") },
        { AuthConfirmEmailText, new("Please use this link to verify your email address: {{BaseHref}}/cmn/auth/verify_email?email={{Email}}&code={{Code}}") },
        ...
        { AuthMagicLinkHtml, new("<div><a href=\"{{BaseHref}}/cmn/auth/magic_link_sign_in?email={{Email}}&code={{Code}}&remember_me={{RememberMe}}\">Please click this link to login</a></div>") },
        { AuthMagicLinkSubject, new("Magic Login Link") },
        { AuthMagicLinkText, new("Please click this link to login: {{BaseHref}}/cmn/auth/magic_link_sign_in?email={{Email}}&code={{Code}}&remember_me={{RememberMe}}") },
        ...
        { AuthResetPwdHtml, new("<div><a href=\"{{BaseHref}}/cmn/auth/reset_pwd?email={{Email}}&code={{Code}}\">Please click this link to reset your password</a></div>") },
        { AuthResetPwdSubject, new("Reset Password") },
        { AuthResetPwdText, new("Please click this link to reset your password: {{BaseHref}}/cmn/auth/reset_pwd?email={{Email}}&code={{Code}}") },
        { AuthThousandsAndDecimalSeparatorsMatch, new("Thousands and decimal separator characters match") },
        ...
        { DeleteAccountWarning, new("This will delete your account and all the data associated with it. Do you still want to delete your account?") },
        ...
        { SendMagicLinkSuccess, new("If this email matches an account an email will have been sent with your magic login link.") },
