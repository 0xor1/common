...
public static class AuthRpcs
{
    ...
    public static readonly Rpc<SendResetPwdEmail, Nothing> SendResetPwdEmail = new(
        "/auth/send_reset_pwd_email"
    );
    public static readonly Rpc<ResetPwd, Nothing> ResetPwd = new("/auth/reset_pwd");
    public static readonly Rpc<SendMagicLinkEmail, Nothing> SendMagicLinkEmail = new(
        "/auth/send_magic_link_email"
    );
    public static readonly Rpc<MagicLinkSignIn, Session> MagicLinkSignIn = new(
        "/auth/magic_link_sign_in"
    );
