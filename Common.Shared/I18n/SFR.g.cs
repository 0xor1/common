...
public static partial class S
{
    ...
    { 
        ...
        { AuthAccountNotVerified, new("Compte non vérifié, veuillez vérifier vos e-mails pour le lien de vérification") },
        ...
        { AuthConfirmEmailHtml, new("<div><a href=\"{{BaseHref}}/cmn/auth/verify_email?email={{Email}}&code={{Code}}\">Veuillez cliquer sur ce lien pour vérifier votre adresse e-mail</a></div>") },
        { AuthConfirmEmailSubject, new("Confirmez votre adresse email") },
        { AuthConfirmEmailText, new("Veuillez utiliser ce lien pour vérifier votre adresse e-mail: {{BaseHref}}/cmn/auth/verify_email?email={{Email}}&code={{Code}}") },
        ...
        { AuthMagicLinkHtml, new("<div><a href=\"{{BaseHref}}/cmn/auth/magic_link_sign_in?email={{Email}}&code={{Code}}&remember_me={{RememberMe}}\">Veuillez cliquer sur ce lien pour vous connecter</a ></div>") },
        { AuthMagicLinkSubject, new("Lien de connexion magique") },
        { AuthMagicLinkText, new("Veuillez cliquer sur ce lien pour vous connecter : {{BaseHref}}/cmn/auth/magic_link_sign_in?email={{Email}}&code={{Code}}&remember_me={{RememberMe}}") },
        ...
        { AuthResetPwdHtml, new("<div><a href=\"{{BaseHref}}/cmn/auth/reset_pwd?email={{Email}}&code={{Code}}\">Veuillez cliquer sur ce lien pour réinitialiser votre mot de passe</a></div>") },
        { AuthResetPwdSubject, new("Réinitialiser le mot de passe") },
        { AuthResetPwdText, new("Veuillez cliquer sur ce lien pour réinitialiser votre mot de passe: {{BaseHref}}/cmn/auth/reset_pwd?email={{Email}}&code={{Code}}") },
        { AuthThousandsAndDecimalSeparatorsMatch, new("Les milliers et les caractères séparateurs décimaux correspondent") },
        ...
        { DeleteAccountWarning, new("Cela supprimera votre compte et toutes les données qui y sont associées. Voulez-vous toujours supprimer votre compte ?") },
        { Deleting, new("Suppression") },
        { Demo, new("Démo") },
        { DemoTitle, new("Cette application est uniquement destinée à des fins de démonstration.\nToutes les données peuvent être effacées à tout moment et sans avertissement.") },
        { Email, new("E-mail") },
        ...
        { RequestBodyTooLarge, new("Corps de la requête trop volumineux, limitez {{MaxSize}} octets") },
        ...
        { SendMagicLinkSuccess, new("Si cet email correspond à un compte, un email vous aura été envoyé avec votre lien de connexion magique.") },
        ...
        { StringInvalid, new("Chaîne non valide {{Name}}, Min {{Min}}, Max {{Max}}, Regexes {{Regexes}}") },
        { Success, new("Succès") },
